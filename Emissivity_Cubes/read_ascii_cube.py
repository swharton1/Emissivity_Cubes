...
class read_ascii_cube():
    '''This function will read in the OpenGGCM ASCII files or PPMLR dat files to get the emissivity data from model runs. The OpenGGCM text files are not in the default path location. 
    '''

    def __init__(self, filename="S05D20V400B0000-05rad.dat", xmin=None, xmax=None, ymin=None, ymax=None, zmin=None, zmax=None, filetype='PPMLR'):
