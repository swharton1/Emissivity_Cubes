...
class read_batsrus_cube():
    '''This function will read in the BATSRUS cube files to get the emissivity 
    data from model runs. 
    '''

    def __init__(self, filename="px_uni_1000.dat", xmin=None, xmax=None, ymin=None, ymax=None, zmin=None, zmax=None):

        self.batsrus_path = os.environ.get("BATSRUS_PATH")
        print (self.batsrus_path) 
        self.plot_path = os.environ.get("PLOT_PATH")
        
        self.filename=self.batsrus_path+filename
